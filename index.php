		...
		<?php
		   ...
		   <form method="get">
				...
				<div class="input-group mbi">
				 ...
				 <input class="form-control" type="text" name="host" placehodler="1.2.3.4" aria-describedby="basic-addon1">
			 	</div>
				<div class="input-group mbi">
				 <span class="input-group-addon" id="basic-addon2">Sekunden</span>
				 <input class="form-control" type="text" name="time" placehodler="30" aria-describedby="basic-addon2">
				</div>
